...
- (void)didUpdateObject:(id)object atIndexPath:(NSIndexPath*)indexPath {
  [_delegates makeObjectsPerformSelector:@selector(model:didUpdateObject:atIndexPath:) withObject:self
              withObject:object withObject:indexPath];
}

- (void)didInsertObject:(id)object atIndexPath:(NSIndexPath*)indexPath {
  [_delegates makeObjectsPerformSelector:@selector(model:didInsertObject:atIndexPath:) withObject:self
              withObject:object withObject:indexPath];
}

- (void)didDeleteObject:(id)object atIndexPath:(NSIndexPath*)indexPath {
  [_delegates makeObjectsPerformSelector:@selector(model:didDeleteObject:atIndexPath:) withObject:self
              withObject:object withObject:indexPath];
}
